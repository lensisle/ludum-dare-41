...
if check_drag
{
	...
	var another_hovered = obj_glass_large.is_hovered || obj_glass_medium.is_hovered;
	...
	if mouse_check_button_pressed(mb_left) && is_hovered
	{
		if current_state == EDraggrableState.Idle && obj_play_manager.allow_selecting_cup
		{
			...
			obj_play_manager.current_cup_selected_index = 1;
			...
			obj_glass_medium.current_state = EDraggrableState.Idle;
